package com.wishtrack.jgge.input;

/**
 *  The GameAction class is an abstract to a user-initiated action,
 *  like jumping or moving. GameActions can be mapped to keys or the mouse
...
public class GameAction {
	...
	/**
    Normal behaviour. The isPressed() method returns true
...
/**
 * Initial press behaviour. The isPressed() method returns true only
 * after the first key is pressed, and not again until the key is 
