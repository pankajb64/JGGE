package com.wishtrack.jgge.util;
...
/**
    Signals that a PooledThread has started. Does nothing here 
    but will be used later (in SoundManager).
*/
...
/**
    Signals that a PooledThread has stopped. Does nothing here 
    but will be used later (in SoundManager).
*/
